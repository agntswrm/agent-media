...
- Updated dependencies [47df559]
  ...
  - @agent-media/image@0.10.0
  - @agent-media/audio@0.5.5
  - @agent-media/video@0.3.5

## 0.13.1

### Patch Changes

- 13d8db3: Read CLI version from package.json instead of hardcoded value so --version reports the correct published version
...
- Updated dependencies [7c055c4]
  ...
  - @agent-media/image@0.9.0
  - @agent-media/audio@0.5.4
  - @agent-media/video@0.3.4
...
- Updated dependencies [8a08b63]
  ...
  - @agent-media/image@0.8.0
  - @agent-media/providers@0.11.0
  - @agent-media/audio@0.5.3
  - @agent-media/video@0.3.3
...
- 4bf1fbf: Add missing skills for image-edit and image-extend actions
